...
const mongoUrl = 'mongodb+srv://Comps381f:Comps381f@cluster0.wfzat.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0';
    ...
    try {
        ...
        if (championKey) {
            ...
            res.render('addFavorite', { 
                ...
                role, 
                notes, 
                championData: Object.keys(championData).map(key => ({
                    id: championData[key].id, 
                    name: championData[key].name 
                })) 
            });
